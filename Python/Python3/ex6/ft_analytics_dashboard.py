def set_mastery(all_players: list):
...
def list_mastery(all_players: list):

    print("\n=== List Comprehension Examples ===")

    online_players = [player['name'] for player in all_players
                      if player['online']]
    high_score = [player['name'] for player in all_players
...
def dict_mastery(all_players: list):
...
def master_mastery(all_players: list):
    ...
    best_score_online = [player['score'] for player in all_players if
                         player['name'] == best_online]
